                ...
                <div className="h-[83vh]">
                  ...
                  <div className="h-full mt-5 space-y-4 overflow-y-scroll hideScrollBar">
                    {message.chats.map((item) => (
                      <div key={item.chatId} onClick={() => handleChatSelect(item)}>
              ...
              <div>
                <div className="flex items-center justify-between p-5 border-l">
                  <div className="flex items-center space-x-3">
                    ...
                    <p>
                      {auth.user?.id === currentChat.admin.id
                        ? currentChat.chats[0].name
                        : currentChat.admin.name}
                    </p>
                  </div>
                ...
                <div ref={chatContainerRef} className="hideScrollBar overflow-y-scroll h-[82vh] px-2 space-y-5 py-5">
                  {messages.map((item) => (
                    <ChatMessage key={item.msgId} message={item} />
                  ))}
                </div>
                <div className="sticky bottom-0 border-l">
                  {selectedImage && (
                    <img className="w-[5rem] h-[5rem] object-cover px-2" src={selectedImage} alt="Selected" />
                  )}
